...
import { GetTransporterFleetUnitByFieldQuery } from '../gettransporterfleetunitbyfield.query';
import { TransporterFleetUnitQueryService } from '../../services/transporterfleetunitquery.service';

@QueryHandler(GetTransporterFleetUnitByFieldQuery)
export class GetTransporterFleetUnitByFieldHandler implements IQueryHandler<GetTransporterFleetUnitByFieldQuery> {
  constructor(private readonly queryService: TransporterFleetUnitQueryService) {}

  async execute(query: GetTransporterFleetUnitByFieldQuery) {
