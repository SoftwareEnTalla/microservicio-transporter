...
@Module({
  controllers: [TransporterFleetUnitCommandController],
  providers: [
  ...
  exports: [TransporterFleetUnitAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthTransporterFleetUnitModule {}
