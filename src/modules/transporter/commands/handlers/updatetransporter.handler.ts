...
import { UpdateTransporterCommand } from "../updatetransporter.command";
...
export class UpdateTransporterHandler
  implements ICommandHandler<UpdateTransporterCommand>
{
  constructor(
    private readonly commandService: TransporterCommandService
  ) {}
  async execute(command: UpdateTransporterCommand) {
